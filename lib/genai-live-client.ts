 ...
 */
// Fix: Property 'emit' does not exist on type 'GenAILiveClient'. Convert `LiveClientEventTypes` interface to a type to resolve a potential TypeScript inheritance issue.
export type LiveClientEventTypes = {
...
export class GenAILiveClient extends EventEmitter<LiveClientEventTypes> {
  ...
  protected sessionPromise: Promise<Session> | null = null;
  ...
  public connect(config: LiveConnectConfig): boolean {
    ...
    this.sessionPromise
      ...
      .catch(e => {
        // onError and onClose will be called by the SDK
      });
